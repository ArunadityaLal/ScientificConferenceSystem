            ...
            <div className="space-y-6">
              <Card className={`shadow-xl backdrop-blur ${
                ...
                <CardContent className="space-y-4 text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    <div className={`p-1 rounded ${isDark ? 'bg-indigo-800' : 'bg-indigo-100'}`}>
                      <Timer className={`h-4 w-4 ${isDark ? 'text-indigo-400' : 'text-indigo-600'}`} />
                    </div>
                    <div>
                      <p className={`font-medium ${isDark ? 'text-white' : 'text-gray-900'}`}>Duration Calculation</p>
                      <p className={`text-xs ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
              ...
              <Card className={`shadow-xl backdrop-blur ${
                ...
                <CardContent className="space-y-3 text-sm">
                  <div className={`p-3 rounded-lg border ${
                    ...
                    <p className={`font-medium ${isDark ? 'text-blue-200' : 'text-blue-700'}`}>Event Selection</p>
                  ...
                  <div className={`p-3 rounded-lg border ${
                    ...
                    <p className={`font-medium ${isDark ? 'text-green-200' : 'text-green-700'}`}>Quick Setup</p>
                  ...
                  <div className={`p-3 rounded-lg border ${
                    ...
                    <p className={`font-medium ${isDark ? 'text-orange-200' : 'text-orange-700'}`}>Check Conflicts</p>
