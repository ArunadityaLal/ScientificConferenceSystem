// app/event-manager/faculty/page.tsx
"use client";
...
export default function FacultyManagementPage() {
    ...
    return new Promise((resolve, reject) => {
      ...
      reader.onload = (e) => {
        try {
          ...
          const facultyMembers: FacultyMember[] = jsonData.map(
  ...
  const handleUpload = async () => {
    ...
    try {
      const facultyMembers = await processExcelFile(
        selectedFile,
        selectedEventId
      );
      ...
      const existingEventData = eventFacultyData.find(
        (data) => data.eventId === selectedEventId
      );
      ...
      const updatedEventFacultyData = eventFacultyData.filter(
        (data) => data.eventId !== selectedEventId
      );
      ...
      localStorage.setItem(
        "eventFacultyData",
        JSON.stringify(updatedEventFacultyData)
      );
  ...
  const handleDeleteEventFaculty = (eventId: string) => {
    ...
    if (
      ...
      const updatedData = eventFacultyData.filter(
      ...
      setSuccessMessage(
        `Deleted faculty data for "${eventData.eventName}" successfully!`
      );
    }
  };
  ...
  const handleExportEventFaculty = (eventData: EventFacultyData) => {
    try {
      ...
      setSuccessMessage(
        `Exported ${eventData.totalCount} faculty members to "${fileName}"!`
      );
    } catch (error) {
  ...
  const filteredEventFacultyData =
    filterEvent === "ALL"
      ? eventFacultyData
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-muted-foreground">
                  Upload and manage faculty lists for your events
                </p>
              </div>
                    ...
                    <div className="text-xs text-gray-600 space-y-2">
                      <div>
                        ...
                        <ul className="list-disc ml-4 space-y-1">
                          <li>
                            <strong>Name:</strong> Name, Full Name, First Name,
                            Faculty Name, etc.
                          </li>
                          <li>
                            <strong>Email:</strong> Email, E-mail, Email
                            Address, Mail, etc.
                          </li>
                        </ul>
                      </div>
                      <div>
                        ...
                        <ul className="list-disc ml-4 space-y-1">
                          <li>
                            <strong>Department:</strong> Department, Dept,
                            Division, etc.
                          </li>
                          <li>
                          ...
                          <li>
                            <strong>Phone:</strong> Phone, Mobile, Contact, etc.
                          </li>
                        </ul>
                      </div>
                      <div className="bg-blue-100 p-2 rounded mt-2">
                        ...
                        <p className="text-blue-700">
                          The system automatically detects column names in
                          various formats.
                        </p>
                      </div>
                    </div>
                    ...
                    {filteredEventFacultyData.length > 0 ? (
                            ...
                            <div className="flex items-center justify-between mb-4">
                              ...
                              <div className="flex space-x-2">
                                ...
                                <Button
                                  ...
                                  variant="outline"
                                  onClick={() =>
                                    handleExportEventFaculty(eventData)
                                  }
                                ...
                                <Button
                                  ...
                                  variant="outline"
                                  onClick={() =>
                                    handleDeleteEventFaculty(eventData.eventId)
                                  }
                      ...
                      <div className="text-center py-16 bg-gradient-to-b from-gray-50 to-white rounded-lg border-2 border-dashed border-gray-200">
                        ...
                        <p className="text-gray-500 mb-6 max-w-md mx-auto">
                          Get started by uploading your first faculty list using
                          the form on the left. You can manage multiple events
                          and their faculty lists from here.
                        </p>
